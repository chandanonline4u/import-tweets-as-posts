...
class TwitterOAuth {
  ...
  /*= Get a request_token from Twitter (@returns a key/value array containing oauth_token and oauth_token_secret )
  ------------------------------------- */
  ...
  /*= Make an HTTP request ( @return API results )
  ----------------------------------------------------*/
